...
struct qt_meta_stringdata_CLASScafe_menagementENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASScafe_menagementENDCLASS = QtMocHelpers::stringData(
    "cafe_menagement",
...
Q_CONSTINIT static const uint qt_meta_data_CLASScafe_menagementENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject cafe_menagement::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASScafe_menagementENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASScafe_menagementENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASScafe_menagementENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *cafe_menagement::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASScafe_menagementENDCLASS.stringdata0))
