...
struct qt_meta_stringdata_CLASScashier_interfaceENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASScashier_interfaceENDCLASS = QtMocHelpers::stringData(
    "cashier_interface",
...
Q_CONSTINIT static const uint qt_meta_data_CLASScashier_interfaceENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject cashier_interface::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASScashier_interfaceENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASScashier_interfaceENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASScashier_interfaceENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *cashier_interface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASScashier_interfaceENDCLASS.stringdata0))
