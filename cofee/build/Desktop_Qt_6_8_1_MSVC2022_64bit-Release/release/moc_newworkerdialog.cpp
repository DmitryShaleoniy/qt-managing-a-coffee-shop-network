...
namespace {
struct qt_meta_tag_ZN15NewWorkerDialogE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN15NewWorkerDialogE = QtMocHelpers::stringData(
    "NewWorkerDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15NewWorkerDialogE[] = {
...
Q_CONSTINIT const QMetaObject NewWorkerDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15NewWorkerDialogE.offsetsAndSizes,
    qt_meta_data_ZN15NewWorkerDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15NewWorkerDialogE_t,
        // Q_OBJECT / Q_GADGET
...
{
    auto *_t = static_cast<NewWorkerDialog *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *NewWorkerDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15NewWorkerDialogE.stringdata0))
