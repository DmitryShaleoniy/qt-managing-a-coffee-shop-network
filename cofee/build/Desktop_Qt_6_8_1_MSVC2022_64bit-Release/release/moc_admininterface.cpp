...
namespace {
struct qt_meta_tag_ZN14AdminInterfaceE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN14AdminInterfaceE = QtMocHelpers::stringData(
    "AdminInterface",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14AdminInterfaceE[] = {
...
Q_CONSTINIT const QMetaObject AdminInterface::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14AdminInterfaceE.offsetsAndSizes,
    qt_meta_data_ZN14AdminInterfaceE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14AdminInterfaceE_t,
        // Q_OBJECT / Q_GADGET
...
void *AdminInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14AdminInterfaceE.stringdata0))
