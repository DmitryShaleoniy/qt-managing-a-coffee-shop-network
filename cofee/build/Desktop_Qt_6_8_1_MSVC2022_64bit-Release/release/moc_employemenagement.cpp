...
namespace {
struct qt_meta_tag_ZN17EmployeMenagementE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN17EmployeMenagementE = QtMocHelpers::stringData(
    "EmployeMenagement",
...
Q_CONSTINIT static const uint qt_meta_data_ZN17EmployeMenagementE[] = {
...
Q_CONSTINIT const QMetaObject EmployeMenagement::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17EmployeMenagementE.offsetsAndSizes,
    qt_meta_data_ZN17EmployeMenagementE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17EmployeMenagementE_t,
        // Q_OBJECT / Q_GADGET
...
void *EmployeMenagement::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17EmployeMenagementE.stringdata0))
