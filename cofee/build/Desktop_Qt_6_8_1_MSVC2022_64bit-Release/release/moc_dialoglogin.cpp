...
namespace {
struct qt_meta_tag_ZN11DialogLogInE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11DialogLogInE = QtMocHelpers::stringData(
    "DialogLogIn"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11DialogLogInE[] = {
...
Q_CONSTINIT const QMetaObject DialogLogIn::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11DialogLogInE.offsetsAndSizes,
    qt_meta_data_ZN11DialogLogInE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11DialogLogInE_t,
        // Q_OBJECT / Q_GADGET
...
void *DialogLogIn::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11DialogLogInE.stringdata0))
