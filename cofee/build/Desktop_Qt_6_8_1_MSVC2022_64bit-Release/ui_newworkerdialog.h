...
public:
    ...
    void setupUi(QDialog *NewWorkerDialog)
    {
        ...
        depEdit = new QComboBox(NewWorkerDialog);
        depEdit->addItem(QString());
        depEdit->addItem(QString());
        depEdit->addItem(QString());
    ...
    void retranslateUi(QDialog *NewWorkerDialog)
    {
        ...
        depEdit->setItemText(0, QCoreApplication::translate("NewWorkerDialog", "Lateshechka Korolev", nullptr));
        depEdit->setItemText(1, QCoreApplication::translate("NewWorkerDialog", "Lateshechka Solntsevo", nullptr));
        depEdit->setItemText(2, QCoreApplication::translate("NewWorkerDialog", "Lateshechka Pervomayskaya", nullptr));
